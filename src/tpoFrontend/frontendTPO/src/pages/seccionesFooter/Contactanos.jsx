...
export default function Contactanos() {
  return (
    ...
    <main className="max-w-2xl mx-auto p-8 bg-brown-100 rounded shadow mt-10 mb-10">
      <h1 className="text-3xl font-bold text-green-900 mb-4">Contáctanos</h1>
      <p className="mb-4 text-gray-700">
        ¿Tienes alguna consulta, sugerencia o necesitas ayuda? ¡Estamos para ayudarte!
      </p>
      <div className="mb-4">
        <h2 className="text-xl font-semibold text-green-800 mb-2">Información de contacto</h2>
      ...
      <div className="mb-4">
        <h2 className="text-xl font-semibold text-green-800 mb-2">Horario de atención</h2>
        <p>Lunes a Viernes de 9:00 a 18:00 hs</p>
      </div>
      <div>
        <h2 className="text-xl font-semibold text-green-800 mb-2">Redes sociales</h2>
        <ul className="text-gray-800">
